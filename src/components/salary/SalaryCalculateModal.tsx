    ...
    return (
      <div className="fixed inset-0 bg-black/60 z-[100] flex items-center justify-center p-4">
        <div className="bg-surface rounded-[32px] w-full max-w-md p-10 shadow-2xl space-y-6 text-center">
          ...
          <div>
            <h2 className="text-2xl font-bold text-foreground">급여 산출 완료</h2>
    ...
    <div className="fixed inset-0 bg-black/60 z-[100] flex items-center justify-center p-4">
      <div className="bg-surface rounded-[32px] w-full max-w-md p-10 shadow-2xl space-y-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-xl font-bold text-foreground">급여 산출 (위험 액션)</h2>
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            className="h-12 rounded-2xl font-mono border-border bg-surface-2 px-5"
            placeholder="RUN"
          />
        </div>
